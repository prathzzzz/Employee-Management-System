    ...
    public partial class Form1 : Form
    {
        ...
        private void button_Login_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlConnection conn2 = new MySqlConnection(conn);
                string query = "Select * from employee.login where username COLLATE utf8_bin = '" + namebox.Text + "' ";
                ...
                if (dtbt.Rows.Count == 1)
                {
                    ...
                    string savedPassswordHash = dtbt.Rows[0][2].ToString();
                    ...
                    {
                        user = namebox.Text;
                        Form2 f3 = new Form2();              //Here, Form3 existed
                        this.Hide();
                        f3.ShowDialog();
                        Close();
                    }
